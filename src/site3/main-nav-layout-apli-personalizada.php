...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
	<div class="container-fluid">
		<div class="row">
			...
			<div class="navbar-header top-bar dark">

				<!-- Topbar Izq RRSS -->
				<ul class="nav navbar-nav navbar-left">
					<li><a class="navbar-brand" href="portal.php"></a></li>
				</ul>
			...
			<div class="aplication-header" style="background-image:url(./img/layout-aplic-cabecera-fotografica.jpg)">
				<div class="">
					<div class="content-aplication-header">
						<a class="navbar-brand" href="portal.php">
							<img src="./img/aulaeci-layout-aplic-intranet.png" alt="">
						</a>
						<div class="name-aplication">
							<span>Nueva autenticación</span>
							<h2>FECISA</h2>
						</div>
					</div>
				</div>	
